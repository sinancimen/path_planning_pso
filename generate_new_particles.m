function [new_particles, velocities] = generate_new_particles(particles, velocities, pbest_path, gbest_path, w, c1, c2, vmax)
    ...
    path_size = size(cell2mat(particles(1)));
    for i = 1 : swarm_size(1)
        ...
        velocities(i) = mat2cell(saturated_velocity, 3, path_size(2));
        new_particles(i) = mat2cell(cell2mat(particles(i)) + cell2mat(velocities(i)), 3, path_size(2));
    end
end